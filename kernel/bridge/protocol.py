...
# Kernel assembly inject plane (max injectability)
MSG_INJECT_STATUS = 0x30
MSG_INJECT_REGISTER = 0x31
MSG_INJECT_SWAP = 0x32
MSG_INJECT_CALL = 0x33
MSG_INJECT_CLEAR = 0x34
MSG_ERROR = 0xFF
