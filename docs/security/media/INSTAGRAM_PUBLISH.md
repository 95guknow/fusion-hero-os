...
notice (found image, not original work). Assets removed from the repo —
...
3. Paste caption from `docs/security/media/IG_CAPTION.txt`
4. Publish
5. Optional add-on / first comment: number-code caption variants in
   `docs/security/media/meister_hasch_v12/IG_CAPTION_ZAHLENCODE.txt`

## API

No Instagram Graph API token in agent stack by default.
Set `INSTAGRAM_ACCESS_TOKEN` + `IG_USER_ID` for automated publish.
